...
Los ADR **0001–0012** son las decisiones estructurales del arquitecto. Los **0013–0023** consolidan los ADR propuestos en `11-privacidad-y-voto-secreto.md` (ADR-110 a ADR-125), deduplicados. Los **0024–0042** elevan decisiones arquitectónicas que estaban dispersas en el resto del corpus.
...
| [0004](0004-canonicalizacion-jcs-obligatoria.md) | Canonicalización JCS (RFC 8785) obligatoria | Aceptado | Todo hash se calcula sobre JCS con orden byte a byte; sin ella, servidor y auditor obtienen hashes distintos sin que nadie se equivoque. |
