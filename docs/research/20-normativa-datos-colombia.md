...
| RL-12 | L.1581 art. 8 lit. a | Actualizar y rectificar | Autoservicio para datos declarativos (`POST /mi/rectificacion`, ADR-0057): alias, semestre y jornada. El **correo queda fuera a propósito** —es la credencial de acceso, y cambiarlo exige confirmación de posesión, sesión reciente y revocación de sesiones, que no existen todavía—. Semestre y jornada pasaron a ser listas cerradas: como texto libre se podía tumbar `/metricas/salud` escribiendo el propio identificador como estrato | MVP | **Hecho** (2026-08-29) |
