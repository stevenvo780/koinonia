...
| --- | --- | --- | --- |
| 0 | **Verificar lo no verificado** | los 27 `NO VERIFICADO`, sobre todo las 16 amenazas y los 9 puntos de tecnología | pendiente |
...
| `NO VERIFICADO` | T-06 (Robo de sesión) — cookie __Host-, HttpOnly, Secure, SameSite=Lax, 8h absoluto, 60min inactividad, re-auth >30min |
...
| `NO VERIFICADO` | T-12 (Spam/saturación deliberativa) — 3 propuestas/7d, 20 comentarios/24h, 1 objeción/proceso (2ª con respaldo) |
| `NO VERIFICADO` | T-19 (Captura por el grupo organizado) — HHI*≥0.15 marca proceso, alerta si >40% en último 10%, ventana ≥72h imposible acortar, sorteo ≥3x postulantes |
| `NO VERIFICADO` | T-20 (Correlación votante↔voto por temporización) — sin timestamps en urna, lotes k≥10 barajados, sin IP en app |
| `NO VERIFICADO` | T-25 (Abuso del asistente IA) — no publica, entrega borrador, contenido marcado assisted:true, no resume posiciones |
